...
日期：2026-09-16 19:35　分支：`anchor-studio`　HEAD：`5288584`（T1–T6 已提交；
本地领先 `origin/anchor-studio` **12 个提交，尚未推送**）

> **新会话怎么用这份文档**：T1–T6 **已全部落地**，
...
| `c2a01c1` | 交接文档 |
| `5288584` | **T1–T6 全量**：来源两类 / 素材库挑选模式 / 视频走素材库寻址 / 段源 ref 修 bug / 设置页分两区 + 落盘三选 + 体检改口径；新增预览页生成器与 jsdom 冒烟；结构守卫 5 → 29 条 |

---

## 3. ★ 本轮做完的（T1–T6，已提交 `5288584`）
