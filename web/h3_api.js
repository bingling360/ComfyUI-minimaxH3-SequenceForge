...
(function () {
  ...
  const Api = {
    ...
    transcodeSubmit: (payload) => _json("POST", "/h3chain/transcode_submit", payload),
    transcodeJobs: (dir) => _call("/h3chain/transcode_jobs" + (dir ? "?dir=" + encodeURIComponent(dir) : "")),
    transcodeJob: (id) => _call("/h3chain/transcode_job?id=" + encodeURIComponent(id || "")),
    transcodeCancel: (id) => _json("POST", "/h3chain/transcode_cancel", { id }),
